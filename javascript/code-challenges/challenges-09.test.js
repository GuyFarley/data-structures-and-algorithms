...
const checkValues = (obj, value) => {
  ...
  let found = objValues.find(item => item === value);
  if (found) {
    return true;
  } else {
    return false;
...
uses Object.values to determine if any given character in the data set has children.

This function should take in an array of data
